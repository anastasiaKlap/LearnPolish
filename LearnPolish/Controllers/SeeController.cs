...
namespace LearnPolish.Controllers
{
    public class SeeController : Controller
    {
        ...
        public ActionResult Index(int id)
        {
            ...
            return RedirectToAction("NextSee", new { IdL = image.LessonID });

        }
        public ActionResult NextSee(int IdL)
        {
            TempData["IdL"] = IdL;
        ...
        [HttpPost]
        public ActionResult FindNextSee(Image img, string WordSee)
        {
            ...
            return RedirectToAction("NextSee", new { IdL = IdL });
