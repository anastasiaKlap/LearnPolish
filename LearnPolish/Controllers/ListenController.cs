...
namespace LearnPolish.Controllers
{
    public class ListenController : Controller
    {
        ...
        public ActionResult Index(int id)
        {
            ...
            return RedirectToAction("NextListen", new { IdL = image.LessonID });

        }
        public ActionResult NextListen(int IdL)
        {
            TempData["IdL"] = IdL;
        ...
        [HttpPost]
        public ActionResult FindNextListen(Image img, string WordListen)
        {
            ...
            string w = WordListen.ToLower().Trim();
            ...
            return RedirectToAction("NextListen", new { IdL = IdL });
